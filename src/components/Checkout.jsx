               ...
               <form className="needs-validation" noValidate="">
                  <div className="row g-3">
                     <div className="col-sm-6">
                        ...
                        <input placeholder='Nguyen' type="text" className="form-control" id="firstName"   required="" />
                     ...
                     <div className="col-sm-6">
                        ...
                        <input placeholder='Tien Dung' type="text" className="form-control" id="lastName"  required="" />
                        <div className="invalid-feedback">
                     ...
                     <div className="col-12">
                        ...
                        <input type="email" className="form-control" id="email" placeholder="tiendungjr123@gmail.com" />
                        <div className="invalid-feedback">
