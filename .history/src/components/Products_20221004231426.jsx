      ...
      return (
         <>
            <div className="buttons d-flex justify-content-center mb-5 pd-5">
               ...
               <button className='btn btn-outline-dark me-2' onChange={handleOnchange} onClick={() => filterProduct("men's clothing")}>Men's Clothing</button>
