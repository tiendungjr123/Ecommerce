...
const Register = () => {
   return (
      <>
         <button type="button" class="btn btn-outline-dark ms-2" data-bs-toggle="modal" data-bs-target="#registerModal">
            ...
            <div className="modal-dialog">
               <div className="modal-content">
                  ...
                  <div className="modal-body">
                     ...
                     <form>
                        <div class="mb-3">
                           <label htmlFor="exampleInput" class="form-label">User Name</label>
